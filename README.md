...
---
### Repository Architecture - Branches

| Branch | Description |
| :--- | :--- |
| `main` | All files and modules in one folder for DE1-SoC demo/testing. |
| `OrganizedVerilog` | Verilog script separated into separate files as indicated in the directory/file architecture. |
| `DigitalVerilog` | Verilog script adapted from the script generated by Digital. Also in separate files as indicated in the directory/file architecture. |

## Repository Architecture - Directories/Files
