// ============================================================================
// Multi-Effect Audio Processor for DE1-SoC Board
// ============================================================================
// This module implements a simple audio effects processor with 5 effects:
// - Noise Gate (strips background noise below threshold)
// - High Pitch (helium voice effect)
